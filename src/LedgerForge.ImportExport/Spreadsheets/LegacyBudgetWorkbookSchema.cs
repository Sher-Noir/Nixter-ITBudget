...
public static class LegacyBudgetWorkbookSchema
{
    ...
    [
        "Item", "Item Description", "Reason / Purpose", "Estimated Month", "Type",
        "Department", "Location", "# of Units", "Estimated Cost / Unit", "Estimated Cost",
        "Need Level", "Notes", "Internal Category", "Frequency", "Renewal Date", "Vendor",
        "Status", "Approval", "Denial", "Proposed"
    ];

    public static IReadOnlyList<string> ListsHeaders { get; } =
    [
        "Budget Section", "Account Code", "Account Category", "Frequency", "Priority", "Status",
        "Reason / Purpose", "Month", "Type", "Department", "Location", "Need Level", "Internal Category"
    ];
}
